import { E as Ve, V as u, M as k, T as S, S as Pe, Q as Te, a as m, R as We, P as Ge, b as qe } from "./index-v9zV0B3V.js";
...
class et extends Ve {
  constructor(F, je) {
    super(), this.object = F, this.domElement = je, this.domElement.style.touchAction = "none", this.enabled = !0, this.target = new u(), this.cursor = new u(), this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minTargetRadius = 0, this.maxTargetRadius = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = !1, this.dampingFactor = 0.05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.zoomToCursor = !1, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = { LEFT: "ArrowLeft", UP: "ArrowUp", RIGHT: "ArrowRight", BOTTOM: "ArrowDown" }, this.mouseButtons = { LEFT: k.ROTATE, MIDDLE: k.DOLLY, RIGHT: k.PAN }, this.touches = { ONE: S.ROTATE, TWO: S.DOLLY_PAN }, this.target0 = this.target.clone(), this.position0 = this.object.position.clone(), this.zoom0 = this.object.zoom, this._domElementKeyEvents = null, this.getPolarAngle = function() {
      ...
      e.target.copy(e.target0), e.object.position.copy(e.position0), e.object.zoom = e.zoom0, e.object.updateProjectionMatrix(), e.dispatchEvent(we), e.update(), r = a.NONE;
      ...
      return function(Fe = null) {
        ...
        return E = 1, K = !1, z || i.distanceToSquared(e.object.position) > V || 8 * (1 - l.dot(e.object.quaternion)) > V || g.distanceToSquared(e.target) > V ? (e.dispatchEvent(we), i.copy(e.object.position), l.copy(e.object.quaternion), g.copy(e.target), !0) : !1;
      };
    ...
    let E = 1;
    const j = new u(), P = new m(), T = new m(), A = new m(), w = new m(), O = new m(), L = new m(), D = new m(), R = new m(), M = new m(), $ = new u(), y = new m();
    let K = !1;
    const c = [], I = {};
    let W = !1;
    function Ae(t) {
    ...
    const ee = function() {
      ...
      return function(n, i) {
        ...
        if (e.object.isPerspectiveCamera) {
          ...
          e.object.isOrthographicCamera ? (ee(n * (e.object.right - e.object.left) / e.object.zoom / l.clientWidth, e.object.matrix), te(i * (e.object.top - e.object.bottom) / e.object.zoom / l.clientHeight, e.object.matrix)) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."), e.enablePan = !1);
      };
    }();
    function G(t) {
    ...
    function xe(t) {
      O.set(t.clientX, t.clientY), L.subVectors(O, w).multiplyScalar(e.panSpeed), x(L.x, L.y), w.copy(O), e.update();
    }
    function Ne(t) {
    ...
    function le(t) {
      ...
      L.subVectors(O, w).multiplyScalar(e.panSpeed), x(L.x, L.y), w.copy(O);
    }
    function ue(t) {
      const o = N(t), n = t.pageX - o.x, i = t.pageY - o.y, l = Math.sqrt(n * n + i * i);
    ...
    function Y(t) {
      switch (Ze(t), c.length) {
        case 0:
          e.domElement.releasePointerCapture(t.pointerId), e.domElement.removeEventListener("pointermove", Q), e.domElement.removeEventListener("pointerup", Y), e.dispatchEvent(Oe), r = a.NONE;
          break;
        case 1:
          const o = c[0], n = I[o];
    ...
    function me(t) {
      e.enabled === !1 || e.enableZoom === !1 || r !== a.NONE || (t.preventDefault(), e.dispatchEvent(J), Ne(Ke(t)), e.dispatchEvent(Oe));
    }
    function Ke(t) {
